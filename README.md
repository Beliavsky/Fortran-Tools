...
* [Compilers](#compilers)
* [Compilers & Interpeters -- experimental](#compilers-interpreters-experimental)
* [Debugging](#debugging)
...
[formal](https://github.com/szaghi/formal): generate beautiful API documentation websites for Fortran projects, by Stefano Zaghi. It bridges FORD (Fortran Documenter) and VitePress (Vue-powered static site generator) -- it parses Fortran `!<` doc comments and produces a complete, searchable, themed documentation site.
...
[Fortran-HumanEval](https://github.com/GiuLeo01/Fortran-HumanEval): adaptation of the [HumanEval](https://github.com/GiuLeo01/Fortran-HumanEval) benchmark for evaluating Large Language Models on Fortran code generation tasks, by GiuLeo01

[fortran-transpiler](https://github.com/specs-feup/fortran-transpiler): source-to-source compiler by João Bispo, based on the [LARA framework](https://github.com/specs-feup/lara-framework), inspired by [Clava](https://github.com/specs-feup/clava), a C/C++ source-to-source compiler

[Groq-Fortran-agent](https://github.com/Beliavsky/Groq-Fortran-agent): Python script that uses [LLMs on Groq](https://console.groq.com/docs/models) to create Fortran programs, iterating with compiler error messages until they compile and run without error, by Beliavsky. Also [Gemini-Fortran-agent](https://github.com/Beliavsky/Gemini-Fortran-agent) and [OpenAI-Fortran-agent](https://github.com/Beliavsky/OpenAI-Fortran-agent).
...
[Winteracter](http://winteracter.uk/): GUI toolset for the Fortran programming language. It consists of various visual development tools and a substantial subroutine library. Several Fortran compilers are supported. (C)
...
[fortfmt-fix](https://github.com/Dbross/fortfmt-fix): scans Fortran sources and normalizes legacy omitted-width FORMAT descriptors to explicit, standard-compliant widths, by Dbross. The transform is deterministic, idempotent, and designed for CI/pre-commit: one gets portable, warning-free formats without touching semantics or I/O field order.
...
[f2cl](https://github.com/rtoy/f2cl): Fortran to Common Lisp translator written in Common Lisp, by Kevin Broughan and Diane Koorey Willcock
